...
public class ModItems {
	...
	public static Item glass_ethanol;
	public static Item glass_vodka;
	...
	{			
		...
		glass_ethanol = new ItemAlcohol().makeGlass(Items.glass_bottle, false).setUnlocalizedName("glass_ethanol").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":glass_ethanol");
		glass_vodka = new ItemAlcohol().makeGlass(Items.glass_bottle, true).setUnlocalizedName("glass_vodka").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":glass_vodka");
	...
	private static void registerItem() {
		...
		//Alcohol
		GameRegistry.registerItem(glass_ethanol, glass_ethanol.getUnlocalizedName());
		GameRegistry.registerItem(glass_vodka, glass_vodka.getUnlocalizedName());
